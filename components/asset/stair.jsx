...
Files: /home/TA/resource/Laboratory/Stair.glb [2.44MB] > Stair-transformed.glb [565.24KB] (77%)
*/
  ...
  return (
    <group {...props} dispose={null}>
      <RigidBody colliders="trimesh" type="fixed">
        <group position={[-2.932, 0.5, -3.017]} rotation={[Math.PI, 0, Math.PI]} scale={0.3}>
